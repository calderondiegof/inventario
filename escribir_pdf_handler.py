"""Escribe handlers/pdf_handler.py limpio."""
import pathlib

code = r'''"""Handler de comando PDF: búsqueda, listado y envío de remisiones por WhatsApp."""
...
dest = pathlib.Path("handlers/pdf_handler.py")
dest.write_text(code, encoding="utf-8")
print(f"OK: {dest} ({len(code)} chars)")
